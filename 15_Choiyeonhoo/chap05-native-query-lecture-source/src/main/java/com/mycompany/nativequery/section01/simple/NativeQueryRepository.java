package com.mycompany.nativequery.section01.simple;
...
public class NativeQueryRepository {
  ...
  public Menu nativeQueryByResultType(int menuCode) {
    ...
    /* Native Query 수행 결과를 Entity Class에 매핑 시키기 위해서는
    * 모든 컬럼이 처리되어야만 한다.
    * == Entity Class의 한 필드라도 값을 매핑 시키지 않으면 오류 발생*/
	  String query 
		  = "SELECT" +
  ...
  public List<Object[]> nativeQueryByNoResultType() {
    ...
    /* 컬럼을 2개만 조회하기 때문에 Menu Entity Class에 매핑 불가
    *  -> Object[]로 값 저장
    * */
  ...
  public List<Object[]> nativeQueryByAutoMapping() {
    ...
    // 0 번 인덱스 : Category Entity
    // 1 번 인덱스 : menu_code 컬럼 값
