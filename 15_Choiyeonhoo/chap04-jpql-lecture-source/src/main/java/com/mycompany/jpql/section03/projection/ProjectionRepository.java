package com.mycompany.jpql.section03.projection;
...
public class ProjectionRepository {
  ...
  public List<MenuInfo> embeddedTypeProjection() {
    ...
    // Persistence Context에서 관리 X (왜? MenuInfo에는 @Entity Annotation이 없음 == 엔티티 아님)
  ...
  /* 스칼라 타입을 여러개 조회할 경우 Object[] 타입으로 반환 받으면 된다. */
  ...
  public List<CategoryInfo> newCommandProjection() {
    String jpql
        = "SELECT new com.mycompany.jpql.section03.projection.CategoryInfo (c.categoryCode, c.categoryName) FROM Section03Category c";
