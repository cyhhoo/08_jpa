package com.mycompany.jpql.section01.simple;
...
/* JPQL
* - Entity 중심으로 개발 가능한 객체 지향 쿼리
* - 특정 DBMS에 의존하지 않음(SQL 시행 시 각 DBMS에 맞는 SQL 형태로 변경
* */
  ...
  /* TypedQuery를 이용한 단일 컬럼 조회 */
	public String selectSingleMenuByTypedQuery() {
	  ...
	  String resultMenuName = query.getSingleResult();// 결과 1행 얻어오기
                                  // menuCode는 PK라서 결과가 1개만 나올 예정
                          // 만약 결과가 없거나, 1행 초과기 예외 발생
